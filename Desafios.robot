...
Preencher o formulario
    [Tags]  formulario
     ...
     ${num_dias}    Validar Diferenca Entre Datas   2020/03/12  2020/03/22    #Validar se a diferenca da data no texto é igual das diferenças das datas
...
Valida se o carrinho esta vazio
     [Tags]  existe_item
     Acessar a aplicacao saucedemo   
     Click Link      //a[@data-test="shopping-cart-link"]   #Entra no carrinho   
